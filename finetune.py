...
parser.add_argument('--logdir', default='./checkpoints/test0412NoTrans_bldfinetune', help='the directory to save checkpoints/logs')
...
if __name__ == '__main__':
    ...
    if args.resume:  # 自动从生成的模型文件夹中找
        ...
        # 加载之前训练后的模型，然后再用blendedmvs进行finetune
